...
public class ConstantvalueActivity extends Activity{
...
//	 Map<Integer, SearchResult> maps = new HashMap<Integer, SearchResult>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_constantvalue);
		initView();
		initListener();
		initData();
	}
	private void initView() {
		// TODO 自动生成的方法存根
		mSearchGrid = (GridView) findViewById(R.id.conssearchgridview);
		mSearchButton = (Button) findViewById(R.id.consrsearchbutton);
	...
	private void initListener() {
		...
		mBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO 自动生成的方法存根
				mintent.setClass(ConstantvalueActivity.this, FragmentTabHostActivity.class);
